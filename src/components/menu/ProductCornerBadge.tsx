...
/** شارة مستقيمة — تبرز من زاوية البطاقة للخارج */
const ProductCornerBadge = ({ text, color, size = "sm", className }: Props) => {
  ...
  return (
    ...
    >
      <span
        className={cn(
          "inline-block truncate rounded-lg font-black leading-tight shadow-md ring-2 ring-white/90",
          size === "md"

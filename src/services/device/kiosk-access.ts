...
/** فترة إعادة التحقق من الاشتراك على الكشك (ms) */
/** إعادة التحقق من الاشتراك + heartbeat ضمني في check_kiosk_access */
export const KIOSK_SUBSCRIPTION_POLL_MS = appEnv.isProd ? 60_000 : 30_000;

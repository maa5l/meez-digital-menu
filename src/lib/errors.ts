import { getClassifiedErrorMessage } from "@/lib/user-facing-errors";
...
export function getErrorMessage(error: unknown): string {
  ...
  if (direct) {
    ...
    return getClassifiedErrorMessage(parsed ? new Error(parsed) : new Error(direct));
  }
  return getClassifiedErrorMessage(error);
}
